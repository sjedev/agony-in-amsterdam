...
let footage = ["",
              ...
              "<span class='tGreen'>## T-14:30 ##</span><br>(18:00, Yesterday)<br><br>You take note of the bakery in the square, quite an old building that you suspect hasn’t changed much over the years. The hanging signpost painted aqua blue reads “Brood van Bos” in bold, white font – you reckon it’s a family business. It is past the closing the time, yet you see Niels just outside his store accompanied by a cart of nondescript packaged goods.<br><br>As Niels sets off on his way, this other unnamed individual is seen exiting a convenience store in the square. He walks swiftly between the trees in the centre and out of view within a minute. You think to yourself – you ought to inform the detective of this person.",
              "<span class='tGreen'>## T-19:30 ##</span><br>(13:00, Yesterday)<br><br>You can see Blanche and Melānija sat on a bench in the square – they seem to get along well, despite Blanche being new to the area. There is a distinct winter’s chill in the air, but they don’t seem to mind as they eat lunch and converse with each other. You note their friendliness, but don’t know what to make of it. Bonding quickly here is rare.",
              "<span class='tGreen'>## T-23:30 ##</span><br>(09:00, Yesterday)<br><br>The same figure you keep seeing appears once more. Walking rather hastily but without any sort of direction, he is on the phone.<br><br>“Don’t worry, nobody will find out” … “It will be hours before anything happens” he anxiously attempts to assure the person on the other end. Then, he looks up to the sky – for once there aren’t any clouds in view, just the square and the great blue sky – before glancing at the CCTV camera and noticing its presence.<br><br>“Uh, look, I’ll call you back later”. He scurries out of view. "]
  ...
  switch(currentRoom){
    ...
    case "detective":
      if(visited[0] == 0){
        ...
        if (detectiveExtra == 1){
          output.typeString("<br><br>You can also <span class='tBlue'>inform</span> the detective of this unnamed individual.")
        }
      }
      break
  }
