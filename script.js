...
let interrogations = [
  ["","","","",""],
  ["","<span class='tGreen'>Melānija</span>: I was on an evening shift at the hotel, covering the front desk and the restaurant. My shift was from 16:00 to 00:00.","<span class='tGreen'>Saskia</span>: I decided I would go to the bar with some friends from university. I did see Blanche there, but she were sat in the other corner. I can't remember if there was anyone else with her. Probably?","<span class='tGreen'>Niels</span>: I was travelling between my bakery and the hotel – they ordered a batch of bread and various pastries. We don't often get such large orders.","<span class='tGreen'>Blanche</span>: I was out at the bar with some friends, celebrating my new job – we were out late into the evening, probably for too long."],
  ["","<span class='tGreen'>Melānija</span>: I manage the hotel at the square, and I get involved with a bit of everything. I lead the staff team, but also check in guests and help with housekeeping on quiet days. There's a lot of dealing with people as part of the role.","<span class='tGreen'>Saskia</span>: I am a barista at the nearby café, so I prepare drinks and food for our customers. I don’t care about the job that much, it’s just my source of income. Plus, being on-shift takes my mind off other things.","<span class='tGreen'>Niels</span>: I run our local bakery, so, while I bake and make our products, I also must look after the finances and keep us afloat. It gets stressful sometimes, and it has been more of a struggle in recent years.","<span class='tGreen'>Blanche</span>: I am a systems engineer at a large multinational corporation based out of Amsterdam. I develop and refine the company’s processes and manage our current engineering projects. Before this, I worked in the Belgian government as a civil servant."],
  ["","<span class='tGreen'>Melānija</span>: I have been in my job for the last few months. Things got rough back at home, so I eventually moved here for a much-needed change of pace. It's been a struggle to raise the hotel's reputation, but I do try.","<span class='tGreen'>Saskia</span>: Probably eight or nine months I’ve been working here. I realised I couldn’t live off my loan and I was struggling just waiting for each payment. This job gives me some extra cash, but sometimes not enough. Now and then, I still have to raise funds in other ways to make ends meet.","<span class='tGreen'>Niels</span>: This bakery has been my life for the last three decades. Admittedly, things were a lot more straightforward when I first set it up. That was back in my twenties.","<span class='tGreen'>Blanche</span>: I have just moved here to start my new job – I finally get to make use of my degree. For the last three years I have been working for a government agency in Belgium."],
  ["","<span class='tGreen'>Melānija</span>: When I do have time off work, I try to keep active. I think it's important to have a good balance in your life. Running is my favourite.","<span class='tGreen'>Saskia</span>: To be honest, I don't have a lot of free time. When I'm not studying, I'm usually working. And when I'm doing neither, I'm usually fretting how I'm going to pay the bills.","<span class='tGreen'>Niels</span>: My children and I like to play games together on our console. Otherwise, I’m usually in the city – I know it like the back of my hand; I’ve lived here all my life.","<span class='tGreen'>Blanche</span>: I program and bodge together small projects in my free time. I don’t profit from it, but being a good programmer is a good skill to have. I like to think that, anyway."]
]
